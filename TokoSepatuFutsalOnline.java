...
public class TokoSepatuFutsalOnline {
    public static void main(String args[])
    {
        //Inisialisasi objek untuk masing-masing merek
         ...
         System.out.println("PROGRAM JAVA TENTANG PENJUALAN SEPATU");
         ...
         for (i=0; i<jum;i++){
              ...
              switch (kode[i]){
                  ...
                  case 3 : 
                            ...
                            break;
                  case 4 : 
                            barang[i]="SEPATU LARI";
                            harga[i]=267999;
                            diskon[i]=0.2;
                            break;
                  case 5 : 
                            barang[i]="SEPATU SANTAI";
                            harga[i]=899000;
                            diskon[i]=0.1;
                            break;
                  default : 
